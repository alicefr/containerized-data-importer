...
http_file(
    name = "xen-libs",
    sha256 = "ea523e4ecad22da45a7a3f4f98e821caebfed958dfd30c504d2c4ef3aaed52f8",
    urls = [
        "http://download.fedoraproject.org/pub/fedora/linux/updates/33/Everything/x86_64/Packages/x/xen-libs-4.14.0-9.fc33.x86_64.rpm",
        "https://storage.googleapis.com/builddeps/ea523e4ecad22da45a7a3f4f98e821caebfed958dfd30c504d2c4ef3aaed52f8",
    ],
)
...
http_file(
    ...
    urls = [
        "http://download.fedoraproject.org/pub/fedora/linux/releases/33/Everything/x86_64/os/Packages/l/libaio-0.3.111-10.fc33.x86_64.rpm",
        "https://storage.googleapis.com/builddeps/51ae3b86c7a6fd64ed187574b3a0a7e3a58f533a6db80e3bf44be99f5fd72f50",
    ],
)
...
http_file(
    name = "buildah",
    sha256 = "f7ffbd7c8b6ac0e9ca38c596d7862f01c41754c1e56eebbce6fd246c94c944c8",
    urls = [
        "http://download.fedoraproject.org/pub/fedora/linux/releases/33/Everything/x86_64/os/Packages/b/buildah-1.16.2-1.fc33.x86_64.rpm",
        "https://storage.googleapis.com/builddeps/f7ffbd7c8b6ac0e9ca38c596d7862f01c41754c1e56eebbce6fd246c94c944c8",
    ],
)
...
http_file(
    name = "ostree-libs",
    sha256 = "7b43fd487f7693ae4f8c617c7970218c2b7035905148ef13335210411524a8f5",
    urls = [
        "http://download.fedoraproject.org/pub/fedora/linux/releases/33/Everything/x86_64/os/Packages/o/ostree-libs-2020.7-3.fc33.x86_64.rpm",
        "https://storage.googleapis.com/builddeps/7b43fd487f7693ae4f8c617c7970218c2b7035905148ef13335210411524a8f5",
    ],
)
...
http_file(
    ...
    urls = [
        "http://download.fedoraproject.org/pub/fedora/linux/releases/33/Everything/x86_64/os/Packages/l/lvm2-libs-2.03.10-1.fc33.x86_64.rpm",
        "https://storage.googleapis.com/builddeps/dbc237320a73c44c38124da66469d199a49c3361d416f9e7354b9e106043938c",
    ],
)
...
http_file(
    ...
    urls = [
        "http://download.fedoraproject.org/pub/fedora/linux/releases/33/Everything/x86_64/os/Packages/d/device-mapper-event-libs-1.02.173-1.fc33.x86_64.rpm",
        "https://storage.googleapis.com/builddeps/605a07738477a5a7d9c536f84e7df5b3f7c607125c08223151cab4dae1e8b9cb",
    ],
)
...
http_file(
    ...
    urls = [
        "http://download.fedoraproject.org/pub/fedora/linux/releases/33/Everything/x86_64/os/Packages/f/fedora-repos-33-1.noarch.rpm",
        "https://storage.googleapis.com/builddeps/7a541cc42342eca39eb487cf0de670ad374006a7a204c0e1f5ff69b6b509ab6f",
    ],
)
...
http_file(
    name = "libgcc",
    sha256 = "616d19e65a8120719fb52971f4af5397b9f02fce2caf635e0939b956098c2015",
    urls = [
        "http://download.fedoraproject.org/pub/fedora/linux/updates/33/Everything/x86_64/Packages/l/libgcc-10.2.1-6.fc33.x86_64.rpm",
        "https://storage.googleapis.com/builddeps/616d19e65a8120719fb52971f4af5397b9f02fce2caf635e0939b956098c2015",
    ],
)
...
http_file(
    ...
    urls = [
        "http://download.fedoraproject.org/pub/fedora/linux/releases/33/Everything/x86_64/os/Packages/m/mkpasswd-5.5.7-1.fc33.x86_64.rpm",
        "https://storage.googleapis.com/builddeps/6db907dff3ba74017d46db5cd81409971afeebfb9ef529462e8379def5d43cc0",
    ],
)
